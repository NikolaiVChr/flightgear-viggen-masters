...
\ifbool{AJS}{
  ...
  The \variant{} is equipped with two communication radios:
  the FR 29 primary radio, and the FR 31 secondary radio.

  The FR 29 operates in the VHF band 103.000--159.975 MHz
  ...
  The FR 31 operates in the VHF band 104.000--161.975 MHz
...
The radio operation modes, selected with knob \cockpitref{fig:fr29}{item:knob-mode} are the following.
\begin{description}
...
These channels (except guard channel H) are defined in text configuration files,
