...
For example:
\begin{itemize}
  \item For a waypoint fix, holding T1 enters fix mode, releasing it cancels, pressing to TV confirms the new position.
  \item For the Rb 75, holding T1 allows to move the seeker, releasing it recenters, pressing TV locks.
\end{itemize}
