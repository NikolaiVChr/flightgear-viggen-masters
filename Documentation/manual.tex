...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.8\textwidth]{images/displays/ajs-hud-general.png}
...
The reference altitude displayed by the top of altitude bars is set as follows.
\begin{itemize}
  \item During takeoff, reference altitude is fixed at 500m.
  \item During flight, the reference button (keybinding \keys{\shift+R}) sets
    the reference altitude to the current altitude.
  \item If autopilot altitude hold mode is active,
    the reference altitude is the same as the autopilot hold altitude.
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.6\textwidth]{images/displays/ajs-hud-landing.png}
