...
\ifbool{AJS}{%
  The FR 24 radio panel is used to set the operating mode and volume of both the FR 22 and FR 24,
  as well as the FR 24 channel.
  ...
  The FR 29 radio panel is used to set the operating mode and volume of the FR 29.
}
\begin{figure}[h]
  \centering
...
\begin{description}
  ...
  \item[E,F,G,H] Sets the corresponding global channel\AJSonly{ for the FR24.  FR 22 is inactive}.
...
\ifbool{AJS}{
  ...
  Frequency or channel for the FR 22 radio is set through the FR 22 channel selector and frequency selector.
  ...
  \begin{figure}[h]
    ...
    \begin{enumerate}[nosep]
      ...
      \item \label{item:knob-base} Airbase knob and display (showing airbase 21).
        Every sixth position shows ALLM (`general').
