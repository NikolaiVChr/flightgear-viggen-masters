...
\ifbool{AJS}{
  ...
  The three mode buttons (\cockpitref{fig:kv1}{item:kv1-base-button,item:kv1-nr-button,item:kv1-mhz-button}),
...
The first (\cockpitref{fig:wpn-panel}{item:jett-payload}) jettisons all external load,
...
The weapon selection knob (\cockpitref{fig:wpn-panel}{item:wpn-sel}) is used to select weapon types,
...
The switch SERIE/IMPULS (\cockpitref{fig:wpn-panel}{item:impuls})
