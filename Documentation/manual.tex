...
\begin{description}
  ...
  \item[ANF/CBT] Combat mode. Allows using weapons. See \cref{chap:weapon-operation}.
  ...
  \item[LANDING NAV] Instruments landing mode.
    Used for landing with ILS (requires the destination airport to be set in route manager).
