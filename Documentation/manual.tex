...
The backup heading indicator requires AC power. A red-white flag indicates power failure.
}
\JAonly{
...
\paragraph{Backup Attitude Indicator (\cockpitref{fig:front-panel}{item:altimeter-bck})}
