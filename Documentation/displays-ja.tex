...
\paragraph{%
  Artificial Horizon (\figref{fig:mi-flight}{item:horizon})
  and Flight Path Marker (\figref{fig:mi-flight}{item:fpv})
}
...
The heading scale (\figref{fig:mi-flight}{item:heading}) shows current heading with a fixed central marker,
...
and the flight path marker (\figref{fig:mi-flight}{item:fpv})
